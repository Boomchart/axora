...
class EditCard extends Component
{
    ...
    public function getRedemptionsCountProperty()
    {
        return $this->val->redemptions_count;
    }
    ...
    public function rules()
    {
        $rules = [
            ...
            'val.terms' => ['nullable', 'string'],
            'val.redemption_instructions' => ['nullable', 'string'],
    ...
    public function updatedProvider()
    {
        ...
        if ($this->provider == 'reloadly') {
            ...
            if ($products['success'] == true) {
                $this->products = collect($products['data'])->where('status', 'ACTIVE')->where('senderCurrencyCode', 'USD')->where('recipientCurrencyCode', $this->val->currency)->map(function ($data) {
            ...
            if ($products['success'] == true) {
                $this->products = collect($products['data'])->where('currency', $this->val->currency)->map(function ($data) {
    ...
    public function updatedProduct()
    {
        if ($this->product) {
            ...
            if ($data) {
                ...
                $this->val->redemption_instructions =  $data['redemption_instructions'];
    ...
    {
        return view('livewire.admin.country.edit-card');
    }
}
