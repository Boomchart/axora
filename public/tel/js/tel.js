    ...
    var K = 0,
      ...
      w = class {
        ...
        _f() {
          ...
          let m = c("div", { class: d });
          if ((this.a.parentNode?.insertBefore(m, this.a), t || i || e)) {
            (this.k = c("div", { class: "iti__country-container" }, m)),
          ...
          if ((m.appendChild(this.a), this._updateInputPadding(), s)) {
        ...
        _i3() {
          ...
          !t &&
            ...
            t && !r.utils
              ...
              : this.i0(),
            i === "auto" && n && !this.s.iso2 ? this._i4() : this.h();
        }
        _i4() {
          r.autoCountry
          ...
          /\p{L}/u.test(this.a.value) && (u = !0),
            (this._a12 = (l) => {
              ...
              let p = l?.data && /[^+0-9]/.test(l.data),
                h = l?.inputType === "insertFromPaste" && this.a.value;
              p || (h && !t)
                ? (u = !0)
              ...
              ((this._handleKeydownEvent = (l) => {
                if (
                  ...
                  if (t) {
                    let p = this.a.value,
                      h = p.charAt(0) === "+",
                      d = !h && this.a.selectionStart === 0 && l.key === "+",
                      m = /^[0-9]$/.test(l.key),
                      y = i ? m : d || m,
                      g =
                        p.slice(0, this.a.selectionStart) +
                        l.key +
                        p.slice(this.a.selectionEnd),
                      C = this._6(g),
                      v = r.utils.getCoreNumber(C, this.s.iso2),
                      _ =
                    ...
                    if (h) {
                      let x = this.s.iso2;
                      E = this._getCountryFromNumber(C) !== x;
                    }
                    (!y || (_ && !E && !d)) && l.preventDefault();
                  }
                }
              }),
        ...
        _getCountryFromNumber(t) {
          ...
          if (o) {
            let l = this.q[I(o)],
              p = l.indexOf(this.s.iso2) !== -1 && u.length <= o.length - 1;
            if (!(n === "1" && M(u)) && !p) {
              for (let d = 0; d < l.length; d++) if (l[d]) return l[d];
            }
          } else {
          ...
          if (t && r.utils)
            if (n) {
              ...
              (this.maxCoreNumberLength = l.length),
                n === "by" && (this.maxCoreNumberLength = l.length + 1);
      ...
      G = (a) => {
        if (!r.utils && !r.startedLoadingUtilsScript) {
          let t;
          if (typeof a == "string") t = import(/* webpackIgnore: true */ a);
