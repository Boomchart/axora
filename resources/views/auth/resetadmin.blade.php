...
@section('content')
  ...
  <div class="auth-card auth-login-card">
    <div class="auth-header">
      <span class="auth-badge"><i class="bi bi-shield-lock"></i>{{ __('Admin Security') }}</span>
      <h1 class="auth-title">{{ __('Reset Password') }}</h1>
      <p class="auth-subtitle">{{ __('Enter a new password to continue accessing the administrator control panel.') }}</p>
    </div>
