...
$client = new GuzzleHttp\Client([
    ...
    <p>
        If you have questions about API keys or need assistance:
    </p>

    <ul>
        <li><strong>Email:</strong> {{$set->support_email}}</li>
        <li><strong>Documentation:</strong> <a href="{{url('/docs/authentication')}}">Authentication Guide</a></li>
        <li><strong>Dashboard:</strong> <a href="{{route('user.dashboard')}}" target="_blank">Settings → API Keys</a></li>
    </ul>
@endsection