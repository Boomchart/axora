...
<body class="axora-developer-doc-body">
    ...
    <div class="container-fluid">
        ...
        <div class="d-none d-lg-flex align-items-center ms-auto">
            <ul class="navbar-nav flex-row align-items-center gap-4 me-4">
                <li class="nav-item">
                    <a class="nav-link active" href="{{ url('/docs/introduction') }}">{{ __('Developer') }}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ url('/api-reference/countries') }}">{{ __('API Reference') }}</a>
                </li>
            </ul>
    ...
    <div class="axora-doc-mobile-drawer-body">
        <div class="axora-doc-mobile-section">
            ...
            <ul class="axora-doc-mobile-nav">
                ...
                <li>
                    <a class="active" href="{{ url('/docs/introduction') }}">
        ...
        <div class="axora-doc-mobile-section">
            ...
            <ul class="axora-doc-mobile-nav">
                <li>
                    <a class="{{ Request::is('docs/introduction') ? 'active' : '' }}" href="{{ url('/docs/introduction') }}">
                        <i class="bi bi-book"></i>
                        <span class="axora-doc-mobile-link-text">{{ __('Introduction') }}</span>
                    </a>
                </li>

                <li>
                    <a class="{{ Request::is('docs/environments') ? 'active' : '' }}" href="{{ url('/docs/environments') }}">
                        <i class="bi bi-gear"></i>
                        <span class="axora-doc-mobile-link-text">{{ __('Environment') }}</span>
                    </a>
                </li>

                <li>
                    <a class="{{ Request::is('docs/authentication') ? 'active' : '' }}" href="{{ url('/docs/authentication') }}">
                        <i class="bi bi-shield-lock"></i>
                        <span class="axora-doc-mobile-link-text">{{ __('Authentication') }}</span>
                    </a>
                </li>

                <li>
                    <a class="{{ Request::is('docs/errors') ? 'active' : '' }}" href="{{ url('/docs/errors') }}">
                        <i class="bi bi-exclamation-triangle"></i>
                        <span class="axora-doc-mobile-link-text">{{ __('Errors') }}</span>
                    </a>
                </li>

                <li>
                    <a class="{{ Request::is('docs/webhook') ? 'active' : '' }}" href="{{ url('/docs/webhook') }}">
                        <i class="bi bi-arrow-repeat"></i>
                        <span class="axora-doc-mobile-link-text">{{ __('Webhooks') }}</span>
                    </a>
                </li>

                <li>
                    <a class="{{ Request::is('docs/api-keys') ? 'active' : '' }}" href="{{ url('/docs/api-keys') }}">
                        <i class="bi bi-key"></i>
        ...
        <div class="sidebar-content">
            <div class="sidebar-section">
                ...
                <ul class="sidebar-menu">
                    <li class="sidebar-item {{ Request::is('docs/introduction') ? 'active' : '' }}">
                        <a href="{{ url('/docs/introduction') }}">
                            <i class="bi bi-book"></i> {{ __('Introduction') }}
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('docs/environments') ? 'active' : '' }}">
                        <a href="{{ url('/docs/environments') }}">
                            <i class="bi bi-gear"></i> {{ __('Environment') }}
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('docs/authentication') ? 'active' : '' }}">
                        <a href="{{ url('/docs/authentication') }}">
                            <i class="bi bi-shield-lock"></i> {{ __('Authentication') }}
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('docs/errors') ? 'active' : '' }}">
                        <a href="{{ url('/docs/errors') }}">
                            <i class="bi bi-exclamation-triangle"></i> {{ __('Errors') }}
                        </a>
                    </li>

                    <li class="sidebar-item {{ Request::is('docs/webhook') ? 'active' : '' }}">
                        <a href="{{ url('/docs/webhook') }}">
                            <i class="bi bi-arrow-repeat"></i> {{ __('Webhooks') }}
                        </a>
                    </li>
