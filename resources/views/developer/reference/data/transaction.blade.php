...
@section('content')
    <h1>{{$title}}</h1>
    <p class="lead-text">{{__('Retrieve a data top-up transaction by it\'s transaction reference')}}</p>

    <div class="endpoint-box">
        <span class="endpoint-method get">GET</span>
        <span class="endpoint-url">{{url('/')}}/api/v1/data-transactions/{reference}</span>
    </div>
    ...
    <table class="params-table">
        ...
        <tr>
            ...
            <td>required</td>
            <td>The data top-up transaction reference</td>
        </tr>
        </tbody>
    </table>
    ...
    <h3 id="list-all-countries">Get a data top-up transaction</h3>
