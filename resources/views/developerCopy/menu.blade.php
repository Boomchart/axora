    ...
    <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                    ...
                    <div class="d-flex align-items-stretch flex-shrink-0">
                        ...
                        <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                            <a class="text-dark me-5 fs-7 fw-bold" href="{{route('developer.card.all')}}">{{__('API Reference')}}</a>
                            <a class="btn btn-success fw-bold" href="{{route('register')}}" target="_blank">{{__('Create Account')}}</a>
                        </div>
                        <!--end::User -->
                        <!--begin::Aside Toggle-->
        ...
        <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
            ...
            <div class="container-fluid d-flex flex-column flex-md-row flex-stack">
                <!--begin::Copyright-->
                <div class="col-md-12">
                    <span class="text-muted fw-bold me-2">© {{date('Y')}} {{__('All rights reserved.')}} </span>
                    <a href="{{route('home')}}" target="_blank" class="footer-link d-inline-block px-0 pt-1 pb-2">{{$set->site_name}}</a>
                </div>
                <!--end::Copyright-->
            </div>
            <!--end::Container-->
