...
<div class="toolbar" id="kt_toolbar">
    ...
    <div class="post fs-7 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
            <p class="mb-5 text-success"><span class="badge badge-pill badge-success me-3">{{__('Get')}} </span> <i class="text-primary">{{url("/")}}/api/v1/transactions</i></p>
            <div class="row">
                <div class="col-md-12">
                    <div class="card-body">
...
<code class="language-json" style="font-size: 0.70rem !important;" data-lang="json">
{
    "data": [
        {
