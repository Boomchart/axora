...
<div class="toolbar" id="kt_toolbar">
    ...
    <div class="post fs-7 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
            <p class="mb-5 text-success"><span class="badge badge-pill badge-success me-3">{{__('Get')}} </span> <i class="text-primary">{{url("/")}}/api/v1/transactions/{reference}</i></p>
            <div class="row">
                <div class="col-md-12">
                    <div class="card-body">
                        <h4 class="fw-bold fs-6 mb-3">{{__('Headers')}}</h4>
                        <div class="p-10 bg-axora mb-3 rounded-5">
                            <div class="mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="p-10 bg-axora mb-3 rounded-5">
                            <div class="mb-3">
                                <p class="mb-1"> <span class="fw-bold">{{__('reference')}}</span><span class="text-danger">*</span> <span class="badge badge-pill badge-dark">{{__('string')}}</span> </p>
                                <p class="fs-8">{{__('Transaction reference')}}</p>
                            </div>
                        </div>
                    </div>
                </div>
