@extends('errors.menu', ['title' => 'Firewall'])
        ...
        <div class="d-flex flex-column flex-lg-row-fluid">
            <div class="d-flex flex-center flex-column flex-column-fluid">
                <div class="w-lg-700px w-700px">
                    <h1 class="fw-bolder fs-7tx text-white mb-3">{{__('Error')}}</h1>
                    <div class="fs-3 fw-bold text-white mb-10">{{__('System not available try again later')}}</div>
                    <div class="mb-10">
