...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="d-flex gap-3 mb-4">
                        <a href="{{route('register')}}" class="btn btn-primary btn-lg">{{__('Start Building for Free')}}</a>
                        <a href="{{route('developer.index')}}" target="_blank" class="btn btn-outline-primary btn-lg">{{__('View Documentation')}}</a>
                    </div>
                    <div class="hero-stats">
                        ...
                        <div class="hero-stat">
                            <span class="hero-stat-number">3,000+</span>
                            <span class="hero-stat-label">{{__('Global Brands')}}</span>
                        </div>
                        <div class="hero-stat">
                            <span class="hero-stat-number">50M+</span>
                            <span class="hero-stat-label">{{__('Payouts Delivered')}}</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <img src="{{asset('front/img/dash.png')}}" alt="API Dashboard" class="img-fluid rounded shadow-lg">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="logo-carousel">
        <div class="container">
            <p class="logo-carousel-title">{{__('Trusted by industry leaders worldwide')}}</p>
        </div>
        <div class="logo-track">
            <!-- Logos repeated for continuous scroll effect -->
            <div class="logo-item">
    ...
    <section class="code-section">
        <div class="container">
            <div class="row align-items-center g-5">
                <div class="col-lg-5">
                    <h2 class="section-title">{{__('Getting Started with ')}} {{config('app.name')}} {{__(' Gift Card API')}}</h2>
                    ...
                    <div class="d-flex gap-3 mt-4">
                        <a href="{{route('developer.index')}}" target="_blank" class="btn btn-primary">{{__('View Full Documentation')}}</a>
...
<pre><code class="language-bash">curl --request POST \
  --url https://api.giftapi.com/v1/gift-cards/order \
  --header 'Authorization: Bearer YOUR_API_KEY' \
  --header 'Content-Type: application/json' \
  --data '{
    "productId": "amazon-us-25",
    "quantity": 1,
...
const response = await axios.post(
  'https://api.giftapi.com/v1/gift-cards/order',
  {
    productId: 'amazon-us-25',
    quantity: 1,
    recipientEmail: 'recipient@example.com',
...
curl_setopt_array($curl, [
  CURLOPT_URL => "https://api.giftapi.com/v1/gift-cards/order",
...
uri = URI('https://api.giftapi.com/v1/gift-cards/order')
