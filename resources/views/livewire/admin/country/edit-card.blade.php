            ...
            <div class="card-body text-wrap">
                ...
                <div class="mt-10">
                    <div class="bg-secondary px-6 py-5 mb-7 rounded-4">
                        ...
                        <li class="d-flex align-items-center py-1">
                            <span class="bullet me-5 bg-info bullet-vertical"></span> <span><b>{{__('Card ID')}}</b>: {{$val->id}}</span>
                        </li>
                        <li class="d-flex align-items-center py-1">
                ...
                <div class="p-5 mt-10 position-relative zindex-1 border border-secondary bg-secondary rounded-5">
                    <div class="d-flex align-items-center cursor-pointer" id="kt_vendor_{{$val->id}}_button">
                        ...
                        <div class="ps-2">
                            <p class="fs-7 text-dark text-hover-danger mb-0">{{__('Change Vendor')}}</p>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center cursor-pointer" id="kt_edit_{{$val->id}}_button">
                        ...
                        <div class="ps-2">
                            <p class="fs-7 text-dark text-hover-danger mb-0">{{__('Edit Card')}}</p>
                        </div>
                    </div>
                    <hr class="bg-light-border">
    ...
    <div wire:ignore.self id="kt_edit_{{$val->id}}" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_edit_{{$val->id}}_button" data-kt-drawer-close="#kt_edit_{{$val->id}}_close" data-kt-drawer-width="{'md': '500px'}">
        <div class="card w-100">
            <div class="card-header pe-5 border-0">
                <div class="card-title">
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="fs-4 text-gray-900 text-hover-danger me-1 lh-1">{{__('Edit Card')}}</div>
                    </div>
                </div>
                <div class="card-toolbar">
                    ...
                    <form class="form w-100 mb-10" wire:submit.prevent="update">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="fv-row mb-6">
                                    <label class="form-label text-dark fs-7">{{__('Card Title')}}</label>
                                ...
                                <div class="fv-row mb-6">
                                    <label class="form-label text-dark fs-7">{{__('Card Category')}}</label>
                                ...
                                <div class="fv-row mb-6">
                                    <label class="form-label text-dark fs-7">{{__('Card Description')}}</label>
                                    <textarea class="form-control form-control-solid" type="text" rows="5" wire:model="val.description" required placeholder="{{__('Description')}}"></textarea>
                                ...
                                <div class="fv-row mb-6">
                                    ...
                                    <textarea class="form-control form-control-solid" type="text" rows="5" wire:model="val.redemption_instructions" placeholder="{{__('Redemption Instructions')}}"></textarea>
                                    @error('val.redemption_instructions')
                                    <span class="form-text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="fv-row mb-6">
                                    <label class="form-label text-dark fs-7">{{__('Card T & C\'s')}}</label>
                                    <textarea class="form-control form-control-solid" type="text" rows="5" wire:model="val.terms" placeholder="{{__('T & C\'s')}}"></textarea>
                                    @error('val.terms')
                                    <span class="form-text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="text-center my-10">
                                    <button type="submit" class="btn btn-success btn-block me-3 my-2" wire:loading.attr="disabled" wire:target="update">
                                        <span wire:loading.remove wire:target="update">{{__('Update Card')}}</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">{{__('Delete Card')}}</h3>
                ...
                <div class="modal-body">
                    <p>{{__('Are you sure you want to delete this card')}}?</p>
