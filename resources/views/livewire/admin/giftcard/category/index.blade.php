    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-dark fw-bolder my-1 fs-2">{{__('Gift Card Category')}}</h1>
            ...
            <div class="card-header pe-5 border-0">
                <div class="card-title">
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="fs-5 text-gray-900 text-hover-danger me-1 lh-1">{{__('Create a Category')}}</div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="fv-row mb-6">
                                    ...
                                    <input class="form-control form-control-solid" type="text" wire:model.defer="name" required placeholder="{{__('Name of category')}}" />
                                    @error('name')
                                ...
                                <div class="fv-row mb-6">
                                    ...
                                    <textarea class="form-control form-control-solid" rows="8" type="text" wire:model.defer="description" required placeholder="{{__('Description')}}"></textarea>
                                    @error('description')
                                    <span class="form-text text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                                <div class="text-center mt-10">
                                    <button type="submit" class="btn btn-success btn-block me-3 my-2" wire:loading.attr="disabled" wire:target="addCategory">
    ...
    <div class="post fs-7 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                        <div class="input-group input-group-solid mb-5 rounded-4 bg-white">
                            ...
                            <input type="search" class="form-control form-control-solid text-dark rounded-4 bg-white" wire:model="search" placeholder="{{__('Search Category')}}" />
                        </div>
                    </div>
                </div>
            ...
            <div class="" wire:loading.class.delay="opacity-50" wire:target="search, status, orderBy, perPage">
                ...
                <div class="card p-5">
                    <p class="fs-6 text-dark fw-bold mb-1">{{$val->name}}</p>
                    <div class="mt-3">
                        <button id="kt_category_{{$val->id}}_button" class="btn btn-sm btn-outline-dark rounded-pill me-2"><i class="bi bi-pen"></i> {{__('Edit')}}</button>
            ...
            <div class="text-center mt-20">
                ...
                <h3 class="text-dark">{{__('No Gift Card Type Found')}}</h3>
                <p class="text-dark">{{__('We couldn\'t find any article category')}}</p>
            </div>
            @endif
        </div>
    </div>
