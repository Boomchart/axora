<div>
    ...
    <div class="row g-xl-8">
        ...
        <div class="col-md-6 text-end">
            ...
            <button id="kt_addpage_button" class="btn btn-dark me-4"><i class="bi bi-plus-lg"></i> {{__('Add Registration Type')}}</button>
        </div>
    </div>
                ...
                <div class="pb-5 mt-10 position-relative zindex-1">
                    <form class="form w-100 mb-10" wire:submit.prevent="addPage" method="post">
                        <div class="fv-row mb-6">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="name" required placeholder="{{__('Registration Type')}}" />
                            @error('name')
    ...
    <div class="table-responsive">
        <table id="kt_datatable_example_5" class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" wire:loading.class.delay="opacity-50" wire:target="search, status, sortBy, orderBy, perPage, loadMore">
            ...
            <tbody>
                ...
                <div>
                    <livewire:admin.regtype.edit :val=$val :wire:key="$val->id"></livewire:admin.regtype.edit>
                </div>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="text-center mt-20">
        ...
        <h3 class="text-dark">{{__('No Registration Type Found')}}</h3>
    </div>
    @endif
</div>