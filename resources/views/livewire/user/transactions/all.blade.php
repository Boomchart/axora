                                    ...
                                    <table class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" id="kt_datatable_example_5">
                                        <thead>
                                            <tr class="fw-semibold fs-7">
                                                ...
                                                <th class="min-w-200px">{{__('Reference ID')}}</th>
                                            ...
                                            <tr class="cursor-pointer">
                                                ...
                                                <td>
                                                    <div class="symbol symbol-40px symbol-circle me-5">
                                                        <div class="symbol-label fs-3 fw-bolder bg-warning border border-warning">
                                                ...
                                                <td class="fw-bold">{{currencyFormat(number_format($val->amount + $val->charge, 2)).' '.$val->currency}}</td>
