                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-5">
                                        {{substr($val->title, 0, 30)}} <i class="bi bi-clipboard-check text-dark castro-copy fs-5" data-clipboard-text="{{route('blog.article', ['article' => $val->slug])}}" title="{{__('Copy')}}"></i>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="text-center">
                                <button id="kt_edit_{{$val->id}}_button" class="btn btn-sm btn-whitelabel rounded-pill"><i class="bi bi-pen"></i> {{__('Edit')}}</button>
                                <a href="{{route('blog.article', ['article' => $val->slug])}}" target="_blank" class="btn btn-sm btn-secondary rounded-pill"><i class="bi bi-eye"></i> {{__('Preview')}}</a>
                                <a data-bs-toggle="modal" data-bs-target="#delete{{$val->id}}" href="" class="btn btn-sm btn-danger rounded-pill"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
