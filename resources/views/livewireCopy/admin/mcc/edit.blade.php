                ...
                <div class="pb-5 mt-10 position-relative zindex-1">
                    <form class="form w-100 mb-10" wire:submit.prevent="update">
                        <div class="fv-row mb-6 form-floating">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="val.name" required placeholder="{{__('MCC')}}" />
                            @error('val.name')
                        ...
                        <div class="fv-row mb-6 form-floating">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="val.mcc_code" required placeholder="{{__('Code')}}" />
                            @error('val.mcc_code')
                            <span class="form-text text-danger">{{$message}}</span>
                            @enderror
                        </div>
