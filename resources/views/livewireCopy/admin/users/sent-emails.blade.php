            ...
            <div class="table-responsive">
                <table id="kt_datatable_example_5" class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" wire:loading.class.delay="opacity-50" wire:target="search, status, sortBy, orderBy, perPage, loadMore">
                    ...
                    <tbody>
                        ...
                        <div><livewire:admin.message.sent-message :val=$val :type=$type :admin=$admin :wire:key="'kt_message_'. $val->id"></livewire:admin.message.sent-message></div>
                        @endforeach
                    </tbody>
                </table>
                @if($message->total() > 0 && $message->count() < $message->total())
