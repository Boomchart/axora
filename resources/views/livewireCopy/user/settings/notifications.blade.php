            ...
            <div class="table-responsive">
                <table class="table table-row-bordered align-middle gy-6">
                    <tbody class="fs-7 fw-semibold">
                        <!--begin::Table row-->
                        <tr>
                            <td class="min-w-250px fs-7 fw-bold">{{__('Login Alert')}}</td>
                            <td class="w-125px">
                        ...
                        <tr>
                            <td class="min-w-250px fs-7 fw-bold">{{__('Transaction Notifications')}}</td>
                            <td class="w-125px">
                                <div class="form-check form-check-custom form-check-solid">
                        ...
                        <tr>
                            <td class="min-w-250px fs-7 fw-bold">{{__('Promotional Emails')}}</td>
                            <td class="w-125px">
                                <div class="form-check form-check-custom form-check-solid">
