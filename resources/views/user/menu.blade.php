                    ...
                    <div class="menu-fit me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="20px" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer">
                        ...
                        <div class="menu-item"><!--begin:Menu link-->
                            <a class="menu-link @if(route('api.logs')==url()->current()) active @endif" href="{{route('api.logs')}}">
                                ...
                                <span class="menu-title">{{__('API Log')}}</span>
                            </a>
                        </div>
                        <div class="menu-item"><!--begin:Menu link-->
                        ...
                        <div x-data="{ open: false }" class="position-relative">
                            <div @click="open = !open" class="d-flex align-items-center rounded-4 bg-white p-3 cursor-pointer shadow-lg mb-3">
                                ...
                                <div class="ps-1">
                                    ...
                                    <a href="{{route('developer.index')}}" target="_blank" class="fs-9" @click.stop>{{__('API Documentation')}} <i class="bi bi-box-arrow-up-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div x-show="open"
                                 ...
                                 class="position-absolute bottom-100 start-0 mb-2 w-100 bg-white rounded-3 shadow-lg"
                                 style="display: none;">
                                <div class="py-2">
                                    <a href="{{route('user.logout')}}" class="d-flex align-items-center px-4 py-3 text-dark text-hover-primary text-decoration-none">
