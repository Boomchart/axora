                ...
                <div class="col-md-6">
                    <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                        <div class="input-group input-group-solid mb-5 rounded-4 bg-white">
                            ...
                            <input type="search" class="form-control form-control-solid rounded-4 bg-white" wire:model="search" placeholder="<?php echo e(__('Search messages')); ?>" />
                        </div>
                    </div>
                </div>
                ...
                <table id="kt_datatable_example_5" class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" wire:loading.class.delay="opacity-50" wire:target="search, status, sortBy, orderBy, perPage, loadMore">
                    ...
                    <tbody>
                        ...
                        <tr class="fw-semibold fs-7">
                            ...
                            <td><?php echo e(substr($val->subject, 0, 90)); ?>...</td>
...
echo $html;
?></livewire:admin.message.sent-message></div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
                <?php if($message->total() > 0 && $message->count() < $message->total()): ?>
            ...
            <div class="text-center mt-20">
                <div class="symbol symbol-150px symbol-circle me-5 mb-10">
                    <div class="symbol-label fs-1 text-dark bg-whitelabel">
                        <i class="bi bi-envelope text-dark" style="font-size:66px;"></i>
                    </div>
                </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/users/sent-emails.blade.php ENDPATH**/ ?>