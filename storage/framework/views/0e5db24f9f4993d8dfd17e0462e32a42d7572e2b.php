<div>
        ...
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                ...
                <ul class="breadcrumb fw-semibold fs-base my-1 mb-5">
                    ...
                    <li class="breadcrumb-item text-muted">
                        <a href="<?php echo e(route('admin.orders')); ?>" class="text-muted text-hover-info"><?php echo e(__('Orders')); ?></a>
                    </li>
    ...
    <div class="post fs-7 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
            <a href="<?php echo e(route('admin.view.transactions', ['transaction' => $val->transaction->ref_id])); ?>" target="_blank">
                    ...
                    <div class="bg-white rounded-4 border border-secondary p-5">
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-6">
                                ...
                                <p class="text-break"><?php echo e($webhook->created_at->setTimezone($admin->timezone)->toDayDateTimeString()); ?></p>
                            </div>
                            <div class="col-6">
...
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/orders/details.blade.php ENDPATH**/ ?>