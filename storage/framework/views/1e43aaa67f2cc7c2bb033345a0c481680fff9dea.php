        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title"><?php echo e(__('Delete Country')); ?></h3>
                ...
                <div class="modal-body">
                    <p><?php echo e(__('Are you sure you want to delete this Country')); ?>?</p>
...
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/country/edit.blade.php ENDPATH**/ ?>