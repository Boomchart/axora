    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('API Logs')); ?></h1>
                <ul class="breadcrumb fw-semibold fs-base my-1 mb-5">
                    ...
                    <li class="breadcrumb-item text-dark"><?php echo e(__('Logs')); ?></li>
                </ul>
            </div>
            <div class="d-flex align-items-center flex-nowrap text-nowrap py-1 mb-10">
                <button id="kt_filter_button" class="btn btn-dark"><i class="bi bi-filter"></i> <?php echo e(__('Filter')); ?></button>
            </div>
        </div>
                ...
                <div wire:ignore.self id="kt_filter" class="bg-white" data-kt-drawer="true" data-kt-drawer-activate="true" data-kt-drawer-toggle="#kt_filter_button" data-kt-drawer-close="#kt_filter_close" data-kt-drawer-width="{default:'100%', 'md': '500px'}">
                    <div class="card w-100">
                        <div class="card-header pe-5 border-0">
                            <div class="card-title">
                                <div class="d-flex justify-content-center flex-column me-3">
                                    <div class="fs-4 text-gray-900 text-hover-info me-1 lh-1"><?php echo e(__('Filter')); ?></div>
                                </div>
                            </div>
                        ...
                        <div class="card-body text-wrap">
                            ...
                            <div class="fv-row mb-6">
                                <label class="form-label text-dark fs-7"><?php echo e(__('Status Code')); ?></label>
                ...
                <div class="row g-xl-8">
                    <div class="col-lg-12 col-md-12">
                                    ...
                                    <table class="table align-middle table-row-bordered table-row-gray-300 gy-3 gs-7" id="kt_datatable_example_5">
                                        <thead>
                                            <tr class="fw-semibold fs-7">
                                                ...
                                                <th class="min-w-300px"><?php echo e(__('Business')); ?></th>
                                                <th class="min-w-50px"><?php echo e(__('Code')); ?></th>
                                                <th class="min-w-50px"><?php echo e(__('Method')); ?></th>
                                                <th class="min-w-100px"><?php echo e(__('Message')); ?></th>
                                                <th class="min-w-50px"><?php echo e(__('Environment')); ?></th>
                                                <th class="min-w-200px"><?php echo e(__('Url')); ?></th>
                                                <th class="min-w-200px"><?php echo e(__('IP Address')); ?></th>
                                        ...
                                        <tbody class="fw-semibold fs-7">
                                            ...
                                            <tr class="cursor-pointer">
                                                <td <?php if($val->message): ?> id="kt_webhook<?php echo e($val->id); ?>_button" <?php endif; ?>>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?php echo e(route('user.manage', ['client' => $val->business_id, 'type' => 'details'])); ?>" target="_blank" class="btn btn-sm btn-dark rounded-pill me-3"><i class="bi bi-gear-wide-connected"></i> <?php echo e(__('Manage')); ?></a>
                                                </td>
                                                <td><?php echo e($val->business_name); ?></td>
                                                <td><?php echo e($val->status_code); ?></td>
                                                <td><?php echo e($val->method); ?></td>
                                                <td><?php echo e($val->message ? __('True') : __('False')); ?></td>
                                                <td><?php echo e($val->mode); ?></td>
                                                <td><?php echo e($val->url); ?></td>
                                                <td><?php echo e($val->ip_address); ?></td>
                                                <td><?php echo e(\Carbon\Carbon::create($val->created_at)->setTimezone($admin->timezone)->toDayDateTimeString()); ?></td>
                                            </tr>
                                                        ...
                                                        <div class="pb-5 mt-10 position-relative zindex-1">
                                                            <div class="row mb-5">
                                                                <div class="col-12" wire:ignore>
                                                                    <p class="mb-1 fs-7"><?php echo e(__('Message')); ?></p>
                                                                    <?php if(is_array($val->message) == false): ?>
                                                                    <p class="mb-1 fs-7"><?php echo e($val->message); ?></p>
                                                                    <?php else: ?>
                                                                    <pre class="rounded-4">
                                                                        <code class="language-json" style="font-size: 0.85rem !important;" data-lang="json">   
                                                                        <?php echo json_encode(json_decode($val->message, true), JSON_PRETTY_PRINT); ?>
                        ...
                        <div class="text-center mt-20">
                            ...
                            <h3 class="text-dark fw-bold text-uppercase fs-5"><?php echo e(($search) ? __('We couldn\'t find').' "'.$search.'" '.__('Try again?') : __('No API Log Found')); ?></h3>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/api-log.blade.php ENDPATH**/ ?>