                ...
                <div class="pb-5 mt-10 position-relative zindex-1">
                    <form class="form w-100 mb-10" wire:submit.prevent="update">
                        <div class="fv-row mb-6 form-floating">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="val.name" required placeholder="<?php echo e(__('MCC')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="fv-row mb-6 form-floating">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="val.mcc_code" required placeholder="<?php echo e(__('Code')); ?>" />
                            <?php $__errorArgs = ['val.mcc_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center mt-10">
                            <button type="submit" wire:click.prevent="update" class="btn btn-dark btn-block my-2" wire:loading.attr="disabled" wire:loading.class="opacity-50">
...
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/mcc/edit.blade.php ENDPATH**/ ?>