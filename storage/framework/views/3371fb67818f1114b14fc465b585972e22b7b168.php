...
<div class="toolbar" id="kt_toolbar">
    ...
    <div class="post fs-7 d-flex flex-column-fluid min-vh-100" id="kt_post">
        <div class="container">
            <p class="mb-5 text-dark"><span class="badge badge-pill badge-secondary me-3"><?php echo e(__('Get')); ?> </span> <i class="text-dark"><?php echo e(url("/")); ?>/api/v1/cards/{iso2}</i></p>
            <div class="row">
                <div class="col-md-6">
                    <div class="card-body">
...
<?php echo $__env->make('developer.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/developer/card/all.blade.php ENDPATH**/ ?>