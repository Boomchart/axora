<div>
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex justify-content-between mb-5">
            <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Orders')); ?> (<?php echo e(number_format_short($total)); ?>)</h1>
                ...
                <div class="row g-xl-8">
                    <div class="col-lg-12 col-md-12">
                                    ...
                                    <table class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" id="kt_datatable_example_5">
                                        <thead>
                                            <tr class="fw-semibold fs-7">
                                                ...
                                                <th class="min-w-250px"><?php echo e(__('Reference ID')); ?></th>
                                        ...
                                        <tbody class="fw-semibold fs-7">
                                            ...
                                            <tr class="cursor-pointer">
                                                <td>
                                                    <a href="<?php echo e(route('admin.view.orders', ['order' => $val->id])); ?>" class="btn btn-info btn-sm rounded-pill" target="_blank"><?php echo e(__('Manage')); ?></a>
                                                </td>
                                                <td class="fw-bold"><?php echo e($val->transaction->card_name); ?> (<?php echo e($val->transaction->card_country); ?>)</td>
                                                <td class="fw-bold"><?php echo e(currencyFormat(number_format($val->amount, 2)).' '.$val->currency); ?></td>
                                                <td>
                        ...
                        <div class="text-center mt-20">
                            ...
                            <h3 class="text-dark fw-bold"><?php echo e(__('No Orders Found')); ?></h3>
                            <p class="text-dark"><?php echo e(__('We couldn\'t find any orders to this account')); ?></p>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/orders/all.blade.php ENDPATH**/ ?>