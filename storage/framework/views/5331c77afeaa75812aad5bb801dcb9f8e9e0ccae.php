<div>
    ...
    <div class="row g-xl-8">
        <div class="col-md-6">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <div class="input-group input-group-solid mb-5 rounded-4 bg-white">
                    ...
                    <input type="search" class="form-control form-control-solid text-dark rounded-4 bg-white" wire:model.debounce.1000ms="search" placeholder="<?php echo e(__('Search')); ?>" />
                </div>
            </div>
        </div>
        <div class="col-md-6 text-end">
            ...
            <button id="kt_addpage_button" class="btn btn-dark me-4"><i class="bi bi-plus-lg"></i> <?php echo e(__('Add Registration Type')); ?></button>
        </div>
    </div>
            ...
            <div class="card-header pe-5 border-0">
                <div class="card-title">
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="fs-4 text-gray-900 text-hover-danger me-1 lh-1"><?php echo e(__('Add Registration Type')); ?></div>
                    </div>
                </div>
                ...
                <div class="pb-5 mt-10 position-relative zindex-1">
                    <form class="form w-100 mb-10" wire:submit.prevent="addPage" method="post">
                        <div class="fv-row mb-6">
                            ...
                            <input class="form-control form-control-solid" type="text" wire:model.defer="name" required placeholder="<?php echo e(__('Registration Type')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center mt-10">
                            <button type="submit" class="btn btn-dark btn-block my-2" wire:loading.attr="disabled" wire:loading.class="opacity-50" wire:target="addPage">
                                <span wire:loading.remove wire:target="addPage"><?php echo e(__('Submit')); ?></span>
                                <span wire:loading wire:target="addPage"><?php echo e(__('Processing Request...')); ?></span>
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button id="kt_edit_<?php echo e($val->id); ?>_button" class="btn btn-sm btn-info rounded-pill me-2"><?php echo e(__('Edit')); ?></button>
                        <a href="<?php echo e(route('admin.reg.kyc', ['reg' => $val->id])); ?>" target="_blank" class="btn btn-sm btn-dark rounded-pill me-2"><?php echo e(__('KYC Documents')); ?></a>
                        ...
                        <button wire:click="duplicate('<?php echo e($val->id); ?>')" class="btn btn-sm btn-info rounded-pill me-2">
                            <span wire:loading.remove wire:target="duplicate('<?php echo e($val->id); ?>')"><?php echo e(__('Duplicate')); ?></span>
                            <span wire:loading wire:target="duplicate('<?php echo e($val->id); ?>')"><?php echo e(__('Processing Request...')); ?></span>
                        </button>
                    </td>
                </tr>
                <div>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.regtype.edit', ['val' => $val])->html();
    ...
    $response = \Livewire\Livewire::mount('admin.regtype.edit', ['val' => $val]);
    $html = $response->html();
    $_instance->logRenderedChild($val->id, $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?></livewire:admin.regtype.edit>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </tbody>
        </table>
        <?php if($source->total() > 0 && $source->count() < $source->total()): ?>
    ...
    <div class="text-center mt-20">
        ...
        <h3 class="text-dark"><?php echo e(__('No Registration Type Found')); ?></h3>
    </div>
    <?php endif; ?>
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/regtype/index.blade.php ENDPATH**/ ?>