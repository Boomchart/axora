<div>
    ...
    <div class="row g-xl-8">
        ...
        <div class="col-md-6 text-end">
            ...
            <button id="kt_addpage_button" class="btn btn-dark me-4"><i class="bi bi-plus-lg"></i> <?php echo e(__('Add MCC')); ?></button>
        </div>
    </div>
            ...
            <div class="card-header pe-5 border-0">
                <div class="card-title">
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="fs-4 text-gray-900 text-hover-danger me-1 lh-1"><?php echo e(__('Add MCC')); ?></div>
                    </div>
                </div>
                ...
                <div class="pb-5 mt-10 position-relative zindex-1">
                    <form class="form w-100 mb-10" wire:submit.prevent="addPage" method="post">
                        <div class="fv-row mb-6 form-floating">
                            <label class="form-label text-dark fs-7 required"><?php echo e(__('MCC Name')); ?></label>
                            <input class="form-control form-control-solid" type="text" wire:model.defer="name" required placeholder="<?php echo e(__('MCC')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="fv-row mb-6 form-floating">
                            <label class="form-label text-dark fs-7 required"><?php echo e(__('MCC Code')); ?></label>
                            <input class="form-control form-control-solid" type="text" wire:model.defer="mcc_code" required placeholder="<?php echo e(__('Code')); ?>" />
                            <?php $__errorArgs = ['mcc_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
        ...
        <table id="kt_datatable_example_5" class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" wire:loading.class.delay="opacity-50" wire:target="search, status, sortBy, orderBy, perPage, loadMore">
            <thead>
                <tr class="fw-semibold fs-7">
                    ...
                    <th class="min-w-250px"><?php echo e(__('MCC')); ?></th>
                    <th class="min-w-250px"><?php echo e(__('Code')); ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($val->mcc_code); ?></td>
                    <td><?php echo e($val->created_at->setTimezone($admin->timezone)->format('Y/m/d h:i:A')); ?></td>
                    <td class="text-center">
                        <button id="kt_edit_<?php echo e($val->id); ?>_button" class="btn btn-sm btn-dark rounded-pill"><?php echo e(__('Edit')); ?></button>
                ...
                <div>
                    <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.mcc.edit', ['val' => $val])->html();
...
?></livewire:admin.mcc.edit>
    ...
    <div class="text-center mt-20">
        ...
        <h3 class="text-dark"><?php echo e(__('No MCC Found')); ?></h3>
    </div>
    <?php endif; ?>
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/mcc/index.blade.php ENDPATH**/ ?>