...
<script>
    "use strict";
    createToast("success", "<?php echo session('success'); ?>");
</script>
<?php endif; ?>
...
<script>
    "use strict";
    createToast("warning", "<?php echo session('alert'); ?>");
</script>
<?php endif; ?>
...
<script>
    ...
    gallery();
</script><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/partials/extra_scripts.blade.php ENDPATH**/ ?>