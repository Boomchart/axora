            ...
            <div class="card-body text-wrap">
                ...
                <div class="fv-row mb-6">
                    ...
                    <select class="form-select form-select-solid" wire:model="type">
                        ...
                        <option value="<?php echo e($gateway->id); ?>"><?php echo e(str_replace('_', ' ', $gateway->name)); ?></option>
        ...
        <div class="container">
            <div class="row g-xl-8">
                ...
                <div class="col-md-6 text-end">
                    <button id="kt_filter_button" class="btn btn-white text-dark me-4"><i class="bi bi-filter"></i> <?php echo e(__('Filter')); ?></button>
                        ...
                        <table class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" id="kt_datatable_example_5">
                            <thead>
                                <tr class="fw-semibold fs-7">
                                    ...
                                    <th class="min-w-150px"><?php echo e(__('Charge')); ?></th>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/deposit/index.blade.php ENDPATH**/ ?>