    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            <div class="col-md-8 text-center mt-md-4 pt-5">
                <?php if($set->api_resell): ?>
                <div class="center-screen mb-5">
                    <a class="developer-link text-center text-dark" href="<?php echo e(route('developer.index')); ?>" target="_blank">
                        <?php echo e(__('Try our Gift Card Developer API')); ?>
                ...
                <p class="fs-5 pb-2 pb-md-3 mb-3 text-dark"><?php echo e(getUi()->h1_b); ?></p>
                <div>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-success btn-lg rounded-pill me-3"><?php echo e(__('Get Started')); ?></a>
                    <a href="<?php echo e(route('contact')); ?>" class="btn btn-outline-dark btn-lg rounded-pill"><?php echo e(__('Speak to sales')); ?></a>
                </div>
            </div>
            <div class="col-md-11 text-center mt-5">
                <img src="<?php echo e(asset('asset/images/'.getUi()->image1)); ?>" style="max-width:100%; height:auto;" class="rounded-5">
            </div>
        </div>
    </div>
</section>
<?php if($set->giftcard_sell): ?>
        ...
        <div class="col-md-11">
            <div class="card get-color rounded-5">
                <div class="card-body p-md-5 p-5">
                    <div class="row">
                        <div class="col-md-5">
                            <h2 class="fs-1 pb-3 text-dark"><?php echo e(getUi()->h3_t); ?></h2>
                            <p class="fs-5 text-start text-md-start text-dark"><?php echo e(getUi()->h3_b); ?></p>
                        </div>
                        <div class="col-md-7">
                            <div style="
                            height: 400px;
                            background-image: url(<?php echo e(asset('asset/images/'.getUi()->image2)); ?>); 
                            background-repeat: no-repeat; 
                            background-position: right bottom;
                            background-size: contain;
                            "></div>
                            <img src="<?php echo e(asset('asset/images/'.getUi()->image2)); ?>" style="display:none;" class="card-image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-11">
            <div class="card get-color rounded-5">
                <div class="card-body p-md-5 p-5">
                    <div class="row">
                        <div class="col-md-5">
                            <h2 class="fs-1 pb-3 text-success"><?php echo e(getUi()->h4_t); ?></h2>
                            <p class="fs-5 text-start text-md-start text-dark"><?php echo e(getUi()->h4_b); ?></p>
                        </div>
                    </div>
                </div>
                <div style="height: 200px;background-image: url(<?php echo e(asset('asset/images/'.getUi()->image3)); ?>); background-repeat: no-repeat; background-position: bottom;background-size: contain;"></div>
                <img src="<?php echo e(asset('asset/images/'.getUi()->image3)); ?>" style="display:none;" class="card-image">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-body">
                <h2 class="fs-1 pb-3 text-success"><?php echo e(getUi()->h2_t); ?></h2>
                <p class="fs-5 text-start text-md-start pb-2 pb-md-3 mb-3 text-dark"><?php echo e(getUi()->h2_b); ?></p>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-6 px-4 mb-5">
            <div class="card position-relative border-0 pt-4 rounded-5 get-color">
                <div class="card-body">
                    <img src="<?php echo e(url('/').'/storage/app/'.$val->image); ?>" class="d-block mb-4 card-image" width="56" alt="<?php echo e($val->title); ?>">
                    <h3 class="text-dark fw-500 fs-4"><?php echo e($val->title); ?></h3>
                    <p class="text-dark fs-5"><?php echo e($val->details); ?></p>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php if(count(getReview()) > 0 && $set->reviews == 1): ?>
<section class="container py-5 mb-2 mt-md-2 mb-md-4 mt-lg-4 mb-lg-5">
    <h2 class="fs-1 pb-3 text-success"><?php echo e(getUi()->h5_t); ?></h2>
                        ...
                        <figure class="d-flex flex-column px-2 px-sm-0 mb-0 mx-2">
                            <div class="card position-relative border-0 pt-4 rounded-5 get-color">
                                <figcaption class="d-flex align-items-center ps-4 pt-4">
                                    <img src="<?php echo e(url('/').'/storage/app/'.$val->image); ?>" width="48" class="rounded-circle card-image" alt="<?php echo e($val->name); ?>">
                                    <div class="ps-3">
                                        <h4 class="fs-6 fw-500 mb-0"><?php echo e($val->name); ?></h4>
                                        <span class="fs-6 text-dark"><?php echo e($val->occupation); ?></span>
                                    </div>
                                </figcaption>
                                <blockquote class="card-body pb-3 mb-5">
                                    <p class="mb-0 card-text-color fs-5 fw-500">“<?php echo e($val->review); ?>”</p>
                                </blockquote>
                            </div>
                        </figure>
                    </div>
...
<?php endif; ?>
<?php if(count(getBrands()) > 0 && $set->brands == 1): ?>
...
<?php endif; ?>
<?php if(count(getTeam()) > 0 && $set->team == 1): ?>
<section class="container py-5 my-md-3 my-lg-5">
    <h2 class="fs-1 pb-3 text-success"><?php echo e(__('Meet The Team')); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.menu', ['title' => $set->site_desc], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/front/index.blade.php ENDPATH**/ ?>