    ...
    <div class="toolbar pb-0" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <h1 class="text-dark fw-bold my-1 fs-4"><?php echo e(__('Messages')); ?></h1>
                ...
                <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-7 border-gray-300" id="tabs-icons-text" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link text-dark <?php if(route('admin.message', ['type' => 'inbox'])==url()->current()): ?> active <?php endif; ?>" id="tabs-icons-text-1-tab" href="<?php echo e(route('admin.message', ['type' => 'inbox'])); ?>" role="tab" aria-controls="tabs-icons-text-1" aria-selected="true"><?php echo e(__('Inbox')); ?> (<?php echo e(number_format_short_nc($unreadMessage)); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark <?php if(route('admin.message', ['type' => 'sent'])==url()->current()): ?> active <?php endif; ?>" id="tabs-icons-text-2-tab" href="<?php echo e(route('admin.message', ['type' => 'sent'])); ?>" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><?php echo e(__('Sent')); ?> (<?php echo e(number_format_short_nc($sentMessage)); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark <?php if(route('admin.message', ['type' => 'contacts'])==url()->current()): ?> active <?php endif; ?>" id="tabs-icons-text-2-tab" href="<?php echo e(route('admin.message', ['type' => 'contacts'])); ?>" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><?php echo e(__('Contacts')); ?> (<?php echo e(number_format_short_nc($contacts)); ?>)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark <?php if(route('admin.message', ['type' => 'deleted'])==url()->current()): ?> active <?php endif; ?>" id="tabs-icons-text-2-tab" href="<?php echo e(route('admin.message', ['type' => 'deleted'])); ?>" role="tab" aria-controls="tabs-icons-text-2" aria-selected="false"><?php echo e(__('Deleted')); ?> (<?php echo e(number_format_short_nc($deletedMessage)); ?>)</a>
                    </li>
                </ul>
            </div>
            <div class="d-flex align-items-center flex-nowrap text-nowrap py-1">
                <button id="kt_dashboard_button" class="btn btn-white me-4"><i class="bi bi-bell text-dark"></i> <?php echo e(__('Dashboard notification for all users')); ?></button>
                <button id="kt_mass_email_button" class="btn btn-dark me-4"><i class="bi bi-envelope text-white"></i> <?php echo e(__('Email all Subscribers')); ?></button>
            </div>
        </div>
    </div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/message/header.blade.php ENDPATH**/ ?>