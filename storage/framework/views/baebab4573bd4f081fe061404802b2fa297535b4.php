                                    ...
                                    <table class="table align-middle table-row-bordered table-row-gray-300 gy-5 gs-7" id="kt_datatable_example_5">
                                        ...
                                        <tbody class="fw-semibold fs-7">
                                            ...
                                            <tr class="cursor-pointer">
                                                <td>
                                                    <a href="<?php echo e(route('view.orders', ['order' => $val->id])); ?>" class="btn btn-info btn-sm rounded-pill" target="_blank"><?php echo e(__('Manage')); ?></a>
                                                </td>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/user/orders/all.blade.php ENDPATH**/ ?>