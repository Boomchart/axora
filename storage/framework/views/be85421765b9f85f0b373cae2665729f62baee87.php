<div>
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex justify-content-between mb-5">
            <h1 class="text-dark fw-bolder my-1 fs-2"><?php echo e(__('Transactions')); ?> (<?php echo e(number_format_short($total)); ?>)</h1>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/transactions/all.blade.php ENDPATH**/ ?>