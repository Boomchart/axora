                    ...
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="col-md-12">
                            <div class="input-group input-group-solid mb-5 rounded-4 bg-white">
                                ...
                                <input type="search" class="form-control form-control-solid bg-white rounded-4" wire:model.debounce.1000ms="search" placeholder="<?php echo e(__('Search Transaction Reference')); ?>" />
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="card w-100">
                                                ...
                                                <div class="card-body text-wrap">
                                                    ...
                                                    <div class="pb-5 mt-10 position-relative zindex-1">
                                                        ...
                                                        <a wire:click="resendWebhook('<?php echo e($val->id); ?>')" wire:loading.attr="disabled" wire:loading.class="opacity-50" wire:target="resendWebhook('<?php echo e($val->id); ?>')" class="btn btn-block btn-info">
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/users/webhook.blade.php ENDPATH**/ ?>