                ...
                <div class="d-flex flex-stack cursor-pointer" id="kt_message_<?php echo e($tt->id); ?>_button">
                    <div class="d-flex align-items-center">
                        <div class="symbol symbol-45px symbol-circle me-4">
                            <span class="symbol-label bg-danger text-white fw-boldest"><?php echo e(substr(ucwords($tt?->user?->business?->name), 0, 1)); ?></span>
                        </div>
                        <div class="ps-1">
                            <p href="#" class="fs-7 text-dark fw-bold mb-0"><?php echo e($tt?->user?->business?->name); ?></p>
                            <p href="#" class="fs-7 text-dark mb-0"><?php echo e($tt->ticket_id); ?> @ <?php echo e($tt->created_at->setTimezone($admin->timezone)->format('Y/m/d h:i:A')); ?></p>
                            ...
                            <span class="badge badge-sm badge-secondary"><i class="bi bi-paperclip"></i> Attachment</span>
                            <?php endif; ?>
                        </div>
                    </div>
                    <button class="btn btn-dark rounded-pill btn-sm px-5"><?php echo e(__('Details')); ?></button>
                </div>
                <div><?php
if (! isset($_instance)) {
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/ticket/open.blade.php ENDPATH**/ ?>