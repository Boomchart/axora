                                ...
                                <table class="table align-middle table-row-bordered table-row-gray-300 gy-3 gs-7" id="kt_datatable_example_5">
                                    <thead>
                                        <tr class="fw-semibold fs-7">
                                            <th></th>
                                            <th class="min-w-50px"><?php echo e(__('Status Code')); ?></th>
                                            <th class="min-w-50px"><?php echo e(__('Method')); ?></th>
                                            <th class="min-w-100px"><?php echo e(__('Error Message')); ?></th>
                    ...
                    <div class="text-center mt-20">
                        <div class="symbol symbol-150px symbol-circle mb-10 border border-secondary">
                            <div class="symbol-label fs-1 bg-whitelabel">
                                <i class="bi bi-code-square text-dark" style="font-size:66px;"></i>
                            </div>
                        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/users/api-log.blade.php ENDPATH**/ ?>