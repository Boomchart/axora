            ...
            <div class="card-header pe-5 border-0">
                <div class="card-title">
                    <div class="d-flex justify-content-center flex-column me-3">
                        <div class="fs-5 text-gray-900 text-hover-success me-1 lh-1"><?php echo e(__('Edit Method')); ?></div>
                    </div>
                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-8">
                                <div class="fv-row mb-6">
                                    ...
                                    <input class="form-control form-control-solid" type="text" wire:model.defer="val.name" required placeholder="<?php echo e(__('Name of Method')); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="fv-row mb-6">
                                    ...
                                    <textarea class="form-control form-control-solid" type="text" wire:model.defer="val.requirements" rows="5" required placeholder="<?php echo e(__('Payout requirements')); ?>"></textarea>
                                    ...
                                    <?php $__errorArgs = ['val.requirements'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="fv-row mb-6 row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" wire:model.defer="val.pc" placeholder="<?php echo e(__('Percent charge')); ?>" autocomplete="off" class="form-control form-control-solid" <?php if($pc_required==1): ?> required <?php endif; ?>>
                                            <span class="input-group-text border-0">%</span>
                                        </div>
                                        <?php $__errorArgs = ['val.pc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text border-0"><?php echo e($currency->currency_symbol); ?></span>
                                            <input type="number" step="any" wire:model.defer="val.fc" placeholder="<?php echo e(__('Fiat charge')); ?>" autocomplete="off" class="form-control form-control-solid" <?php if($fc_required==1): ?> required <?php endif; ?>>
                                        </div>
                                        <?php $__errorArgs = ['val.fc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
</div><?php /**PATH /Applications/MAMP/htdocs/axora/resources/views/livewire/admin/withdraw/edit.blade.php ENDPATH**/ ?>